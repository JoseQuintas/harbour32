...
CREATE CLASS WvgtstProgressBar INHERIT WvgWindow
...
METHOD wvgtstprogressBar:new( oParent, oOwner, aPos, aSize, aPresParams, lVisible )
...
METHOD wvgtstprogressBar:create( oParent, oOwner, aPos, aSize, aPresParams, lVisible )
...
METHOD wvgtstprogressBar:handleEvent( nMessage, aNM )
...
METHOD PROCEDURE wvgtstprogressBar:destroy()

   ::wvgWindow:destroy()

   RETURN

METHOD wvgtstprogressBar:configure( oParent, oOwner, aPos, aSize, aPresParams, lVisible )

   ::Initialize( oParent, oOwner, aPos, aSize, aPresParams, lVisible )

   RETURN Self

METHOD PROCEDURE wvgtstprogressBar:setCaption( cCaption )
...
METHOD wvgtstprogressBar:draw( xParam )
...
METHOD wvgtstprogressBar:activate( xParam )
...
METHOD wvgtstprogressBar:SetValue( nValue, nRangeMin, nRangeMax, nSpeed )
...
METHOD PROCEDURE wvgtstprogressBar:SetColorBarFG( nColor )
...
METHOD PROCEDURE wvgtstprogressBar:SetColorBarBG( nColor )
